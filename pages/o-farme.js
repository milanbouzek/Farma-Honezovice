...
export default function OFarme() {
  ...
  return (
    <div className="flex min-h-screen bg-green-50"> {/* stejné pozadí jako úvodní */}

      {/* Levé menu */}
      <nav className="w-64 bg-green-700 text-white p-6 flex flex-col">
        <h2 className="text-2xl font-bold mb-6">Menu</h2>
        <Link href="/" className="mb-4 hover:underline">Domů</Link>
        <Link href="/o-farme" className="mb-4 hover:underline">O farmě</Link>
        <Link href="/kontakt" className="mb-4 hover:underline">Kontakt</Link>
        {/* další odkazy */}
      </nav>
