    ...
    <Layout>
      ...
      <div className="space-y-6 text-gray-700">
        ...
        <div>
          ...
          <p>
            Přibyli <strong>2 králíci plemene burgundský králík</strong>.  
            V příštím roce tedy bude nově možnost objednat si i čerstvé králičí maso.  
            Veškeré informace budou upřesněny později.
          </p>
        </div>
